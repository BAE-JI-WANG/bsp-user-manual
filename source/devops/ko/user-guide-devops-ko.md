...
###	대상 서비스의 관리 주체 프로젝트와 프로세스, 릴리스 담당자를 설정합니다
...
###  Create New 버튼을 클릭하여, 개발 계획 작성화면으로 이동합니다
...
###  프로젝트 서비스와 연동하여 관리되고 있는 개발 이슈를 연결합니다
...
###  Configuration에서 설정한 Workflow에 따라 개별 Phase 별 프로세스를 진행합니다
![][devops_014]

###  Apprival을 클릭하면, Approval 서비스와 연동되어 결재 작성화면으로 이동합니다

결재 작성에 대한 설명은 Approval 서비스의 도움말을 참고하시기 바랍니다.
![][devops_015]

###  결재 완료 시, Approved 상태로 변경되며, 해당 버튼을 클릭하면 결재 내역 페이지로 이동하여 확인할 수 있습니다
![][devops_015]

###  Deploy 버튼이 활성화 되며, 해당 버튼을 클릭하여 배포 실행 화면으로 이동합니다
![][devops_016]
...
###  빌드 설정 및 Deploy Type을 선택하여, 배포를 진행합니다
Create New 버튼을 통해, Source Repository에서 Branch를 생성하고 해당 Branch를 배포할 수 있습니다.
![][devops_017]


###  Execute Result에서 Build 로그를 확인할 수 있습니다
![][devops_018]
